...
const ArrayTableGrapher = defineAsyncComponent(
    () => import("../../components/Grapher/ArrayTableGrapher.js"),
);
const DataTableGrapher = defineAsyncComponent(
    () => import("../../components/Grapher/DataTableGrapher.js"),
);
        ...
        return h(Suspense, null, {
            default: () =>
                h(
                    "div",
                    {
                        class: "flex print:block flex-col items-center justify-center",
                    },
                    [h("div", { class: `w-full` }, [grapher])],
                ),
