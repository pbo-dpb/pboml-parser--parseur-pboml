  ...
  renderReadonlyVnode(language) {
    try {
      ...
      doc.documentElement.setAttribute(
        "id",
        this.slice.state.renderedAnchorIdPrefix + language,
      );
      ...
      return h(SvgRenderer, {
        ...
        class: "w-full @4xl/slice:w-2/3 self-center dark:invert flex flex-col",
      });
    } catch (error) {
      return h("div", { class: "text-red-800 font-semibold text-4xl" }, () =>
        h("span", {}, `⚠️`),
      );
    }
  }
