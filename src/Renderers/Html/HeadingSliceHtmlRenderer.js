...
export default class HeadingSliceHtmlRenderer extends SliceHtmlRenderer {
    renderReadonlyVnode(language) {
        ...
        switch (this.slice.level) {
            case 0:
                classes.push(
                    "text-3xl border-b  border-gray-300 dark:border-gray-700",
                );
                break;
            case 1:
                classes.push(
                    "text-2xl border-b  border-gray-300 dark:border-gray-700",
                );
                break;
            case 2:
                classes.push(
                    "text-xl border-b  border-gray-100 dark:border-gray-800",
                );
                break;
            case 3:
        ...
        return h(headingElType, { class: classes.join(" ") }, [
            this.slice.referenced_as?.[language]
                ? h(
                      "span",
                      { class: "opacity-70 font-normal mr-4 tracking-tight" },
                      this.slice.referenced_as[language],
                  )
                : null,
