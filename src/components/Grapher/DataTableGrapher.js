...
export default {
    mixins: [ChartJsMixin],
    props: { datatable: { type: Datatable, required: true } },
                ...
                if (!variable.skip_chart && !variable.is_descriptive) {
                    ...
                    const varEntries = this.datatable.content
                        .map((entry) => {
                            ...
                            let xLabel = entry[descriptiveVariableKey]?.[
                                this.language
                            ]
                    ...
                    let dataset = {
                        ...
                        backgroundColor: varEntries.map(
                            (v) => v.backgroundColor,
                        ),
