...
export default {
          ...
          : {
              labels: [
                h(
                  ...
                  [
                    h("span", RendererStrings[this.language]["top"]),
  ...
  methods: {
      ...
      if (slice.referenced_as?.[this.language])
        labels.push(
          h(
            ...
            {
              class:
                'font-light after:content-["•"] after:text-gray-500 after:mx-1',
            },
      ...
      return h("li", { class: [...levelSpecificClasses, ""].join(" ") }, [
        ...
        item.children && level <= 2
          ? h(
              "ol",
              {},
              ...item.children.map((e) => this.buildVnodeForItem(e, level + 1)),
            )
          : null,
      ]);
    },
    getAnchorsFromObjectAndChildren(parent) {
      ...
      if (parent.children) {
        family.push(
          parent.children.map((ch) => this.getAnchorsFromObjectAndChildren(ch)),
        );
      }
      return family;
    },
