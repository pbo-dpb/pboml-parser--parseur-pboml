    ...
    <main class="flex flex-col justify-between gap-4">
        ...
        <header class="flex flex-row items-center justify-between">
            <div class="tabs">
                <div class="flex flex-row items-center justify-between">
                    <div
                        role="tablist"
                        class="mb-4 flex flex-row gap-4">
                        <Tab
                            :controls="'content'"
            ...
            <editor-previews
                ...
                :disabled="shouldEditRaw"></editor-previews>
        </header>
        ...
        <template v-if="!shouldEditRaw">
            <div
                ...
                <editor-main-content
                    :pboml-document="pbomlDocument"></editor-main-content>
            </div>
            <div
                ...
                <document-meta-editor
                    :pboml-document="pbomlDocument"></document-meta-editor>
            </div>
            <div
...
<script>
    ...
    export default {
        ...
        computed: {
            hasUnlockedContent() {
                return (
                    (this.pbomlDocument?.slices?.some(
                        (slice) => slice.state._unlocked,
                    ) ??
                        false) ||
