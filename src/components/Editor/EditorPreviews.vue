<template>
  <div class="flex flex-col gap-2">
    <nav class="flex flex-row justify-end gap-2">
      ...
      <Button
        :disabled="disabled"
        @click="shouldDisplayPreview = shouldDisplayPreview ? false : 'en'"
  ...
  methods: {
    downloadPboml() {
      ...
      element.setAttribute(
        "href",
        "data:text/pboml;charset=utf-8," + encodeURIComponent(rawtext),
      );
    ...
    injectEnhancedPreviewContent() {
      ...
      const encodedPayload = btoa(
        unescape(encodeURIComponent(this.pbomlDocument.serialize())),
      );
      const container =
        this.enhancedPreviewWindow.document.body.querySelector("div");

      let enPbomlPreview =
        this.enhancedPreviewWindow.document.getElementById("en-pboml-preview");
      ...
      let frPbomlPreview =
        this.enhancedPreviewWindow.document.getElementById("fr-pboml-preview");
