<template>
    <div class="flex flex-col">
        ...
        >
            <PlusCircleIcon aria-hidden="true" class="size-6" /><span
                class="sr-only"
        ...
        computed: {
            buttons() {
                return [
                    ...
                    { label: this.strings.slice_type_table, type: TableSlice },
                    { label: this.strings.slice_type_svg, type: SvgSlice },

                    {
                        label: this.strings.slice_type_kvlist,
                        type: KvListSlice,
                    },
                    { label: this.strings.slice_type_chart, type: ChartSlice },
                    {
