                    ...
                    h("div", { class: "relative" }, [
                        ...
                        annotation.state._unlocked
                            ? h(AnnotationEditor, {
                                  ...
                                  canMoveDown:
                                      i !==
                                      this.pbomlDocument.annotations.length - 1,
                                  onDelete: () => {
                                      this.pbomlDocument.annotations.splice(
                                          this.pbomlDocument.annotations.indexOf(
                                              annotation,
                                          ),
                                          1,
                                      );
