...
export default {
    ...
    render() {
        ...
        return h('div', { 'class': 'flex flex-row gap-1 items-center' }, [
            ...
            h(TinyButton, {
                'aria-label': strings[document.documentElement.lang].move_slice_down_button_label,
            ...
            h(TinyButton, {
                'aria-label': strings[document.documentElement.lang].move_slice_up_button_label,
