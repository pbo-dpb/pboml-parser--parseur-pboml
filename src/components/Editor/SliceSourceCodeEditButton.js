        ...
        TinyButton,
        {
          "aria-label":
            strings[document.documentElement.lang]
              .previewing_slice_button_label,
          "aria-pressed": this.isEditingSource,
          class: this.isEditingSource
            ? "bg-amber-300 hover:bg-amber-500 shadow-inner"
            : "bg-amber-100 hover:bg-amber-300",
          title: this.isEditingSource
            ? strings[document.documentElement.lang].stop_editing_source_code
            : strings[document.documentElement.lang].edit_source_code,
          onClick: (e) => {
