    ...
    render() {
        ...
        let valueActionCells = [
            ...
            ...this.datatable.content.map((ct, index) => {
                return h(
                    "td",
                    { class: "border border-slate-300 bg-slate-50 px-1 py-2 " },
                    [
                        h("div", { class: "flex flex-row justify-end gap-2" }, [
                            h(
                                TinyButton,
                                {
                                    danger: true,
                                    "aria-label":
                                        strings.data_table_editor_delete,
                                    title: strings.data_table_editor_delete,
                                    onClick: () =>
                                        this.datatable.content.splice(index, 1),
                                },
                            ...
                            h(
                                TinyButton,
                                {
                                    ...
                                    "aria-label":
                                        strings.data_table_editor_emphasize,
                                    title: strings.data_table_editor_emphasize,
                                    onClick: () =>
                                        (this.datatable.content[
                                            index
                                        ].emphasize = !ct.emphasize),
                                },
        ...
        Object.entries(this.datatable.variables).forEach((entry) => {
            ...
            headerCol.props["width"] =
                `${100 / (this.datatable.bodyRowsCount + 1)}%`;
            ...
            this.datatable.content.forEach((content) => {
                ...
                if (variable.emphasize && variable.is_descriptive)
                    cellClasses.push("bg-yellow-200");
                else if (content.emphasize && variable.is_descriptive)
                    cellClasses.push("bg-yellow-200");
                else if (content.emphasize && variable.emphasize)
                    cellClasses.push("bg-yellow-200");
                else if (content.emphasize) cellClasses.push("bg-yellow-100");
                else if (variable.emphasize) cellClasses.push("bg-yellow-100");
                else if (variable.is_descriptive)
                    cellClasses.push("bg-slate-200");
                ...
                columns.push(
                    h(
                        "td",
                        {
                            width: `${100 / (this.datatable.bodyRowsCount + 1)}%`,
        ...
        return h("div", { class: "flex flex-col gap-2" }, [
            ...
            h("div", { class: "flex flex-row justify-end" }, [
                h(TinyButton, { onClick: () => this.addValue() }, () => [
