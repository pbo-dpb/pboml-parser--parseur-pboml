...
export default {
    props: {
        variable: { type: DataTableVariable, required: true },
    ...
    render() {
        ...
        let typesInputChoices = {
            markdown: {
                label: strings.data_table_variables_editor_var_type_markdown,
                icon: LanguageIcon,
            },
            number: {
                label: strings.data_table_variables_editor_var_type_number,
                icon: HashtagIcon,
            },
            separator: {
                label: strings.data_table_variables_editor_var_type_separator,
                icon: MinusIcon,
            },
        };
        ...
        let presentationStyleChoices = {
            ...
            accounting:
                strings.data_table_variables_presentation_type_accounting,
        ...
        return h("div", { class: `flex flex-col gap-4 ` }, [
            h("div", { class: "flex flex-row justify-between" }, [
                h(
                    "span",
                    { class: `font-semibold text-gray-800 font-mono text-lg` },
                    this.variableKey,
                ),
                h("div", { class: "flex flex-row gap-2" }, [
                    ...
                    this.variable.is_descriptive
                        ? null
                        : h(
                              TinyButton,
                              {
                                  "aria-label":
                                      strings.data_table_variables_editor_var_skip_chart,
                                  "aria-pressed": !this.variable.skip_chart,
                                  onClick: () => {
                                      this.variable.skip_chart =
                                          !this.variable.skip_chart;
                                      this.$emit(
                                          "update:modelValue",
                                          this.variable,
                    ...
                    h(
                        TinyButton,
                        {
                            ...
                            "aria-label":
                                strings.data_table_variables_editor_var_is_descriptive,
                            onClick: () => {
                                this.variable.is_descriptive =
                                    !this.variable.is_descriptive;
                                this.$emit("update:modelValue", this.variable);
