<template>
    <div class="flex flex-col">
        <DisplayEditorVariable
            v-for="(variable, index) in variablesArray"
            :key="variable.key"
            :variable
            :index
            :draggedSliceIndex="indexOfCurrentlyDraggedVar"
