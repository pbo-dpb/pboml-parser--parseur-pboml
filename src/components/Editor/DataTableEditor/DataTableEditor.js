    ...
    return h("div", { class: "flex flex-col gap-4" }, [
      h("div", { class: "flex flex-row gap-4 items-center" }, [
        h(
          ...
          {
            default: () => [
              h(TableCellsIcon, { class: "size-4" }, () => []),
              editorStrings[this.language].data_table_visual_editor,
            ],
          },
        ),
        h(
          ...
          {
            default: () => [
              h(VariableIcon, { class: "size-4" }, () => []),
              editorStrings[this.language].data_table_variables_editor,
            ],
          },
        ),
        ...
        h(
          ...
          {
            default: () => [
              h(PaintBrushIcon, { class: "size-4" }, () => []),
              editorStrings[this.language].data_table_display_editor,
            ],
          },
        ),
        ...
        h(
          ...
          {
            default: () => [
              h(ArrowDownOnSquareIcon, { class: "size-4" }, () => []),
              editorStrings[this.language].data_table_importer,
            ],
          },
        ),
      ]),
      this.currentTab === "visual"
        ? h(DataTableVisualEditor, {
      ...
      this.currentTab === "variables"
        ? h(DataTableVariablesEditor, {
            datatable: this.datatable,
            id: variablesEditorId,
            showChartProperties: this.showChartProperties,
          })
        : null,
      this.currentTab === "display"
        ? h(DataTableDisplayEditor, {
            datatable: this.datatable,
            id: displayEditorId,
          })
        : null,
