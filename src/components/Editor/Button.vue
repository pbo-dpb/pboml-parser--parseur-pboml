<template>
    <button
        class="rounded-sm p-2 flex flex-row gap-2 items-center justify-center font-semibold disabled:opacity-30 aria-pressed:outline-2 aria-pressed:outline-solid outline-yellow-600"
        :class="{
