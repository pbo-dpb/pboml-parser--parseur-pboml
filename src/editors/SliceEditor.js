...
export default {
  ...
  render() {
    const verbosePresentationStyle =
      editorStrings[this.language][`presentation_${this.slice.presentation}`];
        ...
        h(
          ...
          [
            h(
              ...
              {
                class:
                  "uppercase text-xl font-bold text-slate-500 -mt-2 mb-2 pb-2 border-b-4 border-slate-100 border-dashed",
              },
    ...
    return h("section", { class: "relative" }, [
      this.$attrs.onMoveSlice
        ? h(
            LockStateToggler,
            { class: "absolute -left-8", unlockableObject: this.slice },
            () => [],
          )
        : null,
                  ...
                  h(
                    ...
                    [
                      verbosePresentationStyle
                        ? h("em", {}, verbosePresentationStyle)
                        : null,
                      verboseSliceType ? verboseSliceType : null,
                    ],
                  ),
