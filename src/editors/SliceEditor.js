...
export default {
    ...
    render() {
        const verbosePresentationStyle =
            editorStrings[this.language][
                `presentation_${this.slice.presentation}`
            ];
        const verboseSliceType =
            editorStrings[this.language][`slice_type_${this.slice.type}`];
        ...
        if (this.slice.state.isPreviewing) {
            ...
            currentContext.push(
                h(
                    "div",
                    {
                        class: "border-4 border-slate-100 border-dashed p-4 rounded-sm",
                    },
                    [
                        h(
                            "div",
                            {
                                class: "uppercase text-xl font-bold text-slate-500 -mt-2 mb-2 pb-2 border-b-4 border-slate-100 border-dashed",
                            },
                            `${editorStrings[this.language].editor_actions_preview} (${this.slice.state.isPreviewing})`,
                        ),
                        Renderer.methods.renderSliceAsVnode(
                            this.slice,
                            this.slice.state.isPreviewing,
                        ),
                    ],
                ),
            );
                ...
                h(Suspense, null, {
                    default: () =>
                        h(
                            ...
                            this.slice.__buildEditorsVnode(),
                        ),
        ...
        if (this.slice.presentation === "figure") {
            presentationSpecificHeading.push(
                "bg-slate-300",
                "border-slate-300",
            );
        ...
        return h("section", { class: "relative" }, [
            this.$attrs.onMoveSlice
                ? h(
                      LockStateToggler,
                      {
                          class: "absolute -left-8",
                          unlockableObject: this.slice,
                      },
                      () => [],
                  )
                : null,

            this.slice.state._unlocked
                ? null
                : h(
                      "div",
                      {
                          "aria-hidden": true,
                          class: "grid grid-cols-2 selection-none",
                          inert: true,
                      },
                      [
                          h("div", { class: "-mx-16 scale-75" }, [
                              Renderer.methods.renderSliceAsVnode(
                                  this.slice,
                                  "en",
                              ),
            ...
            this.slice.state._unlocked
                ? h(
                      "fieldset",
                      {
                          class: `border-2 border-slate-300 p-4 flex flex-col gap-4 rounded-sm ${this.slice.readonly ? " filter grayscale opacity-80" : ""}`,
                      },
                      [
                          h(
                              "legend",
                              ...
                              [
                                  h(
                                      "div",
                                      {
                                          class: "font-semibold text-lg flex flex-row gap-2",
                                      },
                                      [
                                          verbosePresentationStyle
                                              ? h(
                                                    "em",
                                                    {},
                                                    verbosePresentationStyle,
                                  ...
                                  h("div", { class: "flex flex-row gap-2" }, [
                                      ...
                                      h(SliceSourceCodeEditButton, {
                                          onEditing: (value) => {
                                              this.resetSliceState();
                                              this.slice.state.isEditingSourceCode =
                                                  value;
                                          },
                                          isEditingSource:
                                              this.slice.state
                                      ...
                                      h(MetaEditingButton, {
                                          isEditing:
                                              this.slice.state.isEditingMeta,
                                          onEditing: (value) => {
                                              this.resetSliceState();
                                              this.slice.state.isEditingMeta =
                                                  value;
