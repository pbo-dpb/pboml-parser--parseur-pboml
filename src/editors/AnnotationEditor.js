...
export default {
    data() {
        return { inuid: Math.random().toString(36).substring(2) };
    },
    ...
    render() {
        ...
        return h(
            "fieldset",
            {
                class: `border-2 border-slate-300 p-4 flex flex-col gap-4 rounded-sm`,
            },
            [
                h(
                    "legend",
                    {
                        class: `text-sm px-2 text-gray-800 border-2 flex flex-row gap-2 items-center w-full justify-between w-full rounded-sm py-2`,
                    },
                    [
                        h(
                            "div",
                            {
                                class: "font-semibold text-lg flex flex-row gap-2 font-mono",
                            },
                            `[^${this.annotation.id}]`,
                        ),
                ...
                this.readonlyId
                    ...
                    : h("div", { class: "flex flex-col gap-1" }, [
                          ...
                          h("input", {
                              ...
                              onChange: (e) => {
                                  this.sanitizeId(e.target.value);
                              },
                          }),
                          this.annotation.id
                              ? h("p", { class: "text-sm" }, [
                                    strings.annotation_id_helper,
                                    h(
                                        "span",
                                        {
                                            class: "font-mono rounded-sm bg-gray-100",
                                        },
                                        `[^${this.annotation.id}]`,
                                    ),
                                ])
                ...
                h(SelectInput, {
                    choices: { Markdown: `markdown`, Bibtex: `bibtex` },
                ...
                this.annotation.content_type === "markdown"
                ...
                this.annotation.content_type === "bibtex"
                    ? h("div", { class: "grid grid-cols-2 gap-4" }, [
                          h("div", {}, [
                              h(BibtexTextarea, {
                                  label: "EN",
