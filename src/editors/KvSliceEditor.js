        ...
        return () => {
            ...
            if (props.isEditingMeta) {
                metas.push(
                    ...
                    h(CheckboxInput, {
                        ...
                        label: strings[document.documentElement.lang]
                            .kv_slice_display_labels_label,
                        "onUpdate:modelValue": (value) => {
                            props.slice.prototype.display_labels = value
                                ? true
                                : false;
                        },
                    }),
            ...
            props.slice.content.forEach((entry) => {
                let kvBlock = h(
                    "div",
                    {
                        class: "flex flex-col gap-2  p-2 border-r-2 border-gray-300",
                    },
                    [
                        h(TinyButton, {
                        ...
                        h("div", { class: "grid grid-cols-2 gap-2" }, [
                            h("div", { class: "flex flex-col font-semibold" }, [
                                h("div", {
                                    class: "",
                                    innerText: `${props.slice.prototype.key.label?.en ?? "Key"} • ${props.slice.prototype.key.label?.fr ?? "Clé"}`,
                                }),
                                h(BilingualInput, {
                                    class: "w-full",
                            ...
                            h("div", { class: "flex flex-col" }, [
                                h("div", {
                                    class: "",
                                    innerText: `${props.slice.prototype.value.label?.en ?? "Value"} • ${props.slice.prototype.value.label?.fr ?? "Valeur"}`,
                                }),
                                h(BilingualInput, {
                                    class: "w-full",
            ...
            return h("div", { class: "flex flex-col gap-4" }, [
                ...
                h(
                    "div",
                    {
                        class: "p-4 bg-slate-100 rounded-sm flex flex-col gap-8",
                    },
                    rows,
                ),
            ]);
