    ...
    setup(props, { emit, expose }) {
            ...
            try {
                ...
                ["en", "fr"].forEach((language) => {
                    if (!props.slice.content[language])
                        props.slice.content[language] =
                            newBitmapSlice.content[language];
                        ...
                        BITMAP_DENSITIES.map((ds) =>
                            BITMAP_FORMATS.map((ft) => {
                                ...
                                if (
                                    ...
                                    newBitmapSlice.thumbnails[language]?.[
                                        keyForThumbnail
                                    ]
                                ) {
        ...
        return () =>
            h("div", { class: "flex flex-col gap-4" }, [
                h(BilingualInput, {
                    label: strings[document.documentElement.lang]
                        .bitmap_slice_source_label,
                    class: "w-full",
                ...
                h("div", { class: "grid grid-cols-2 gap-4" }, [
                    h(
                        "figure",
                        { class: "shadow-sm flex justify-center items-center" },
                        [
                            props.slice.content.en
                                ? h("img", {
                                      src: props.slice.content.en,
                                      class: "max-h-64",
                                  })
                                : h("span", "❌"),
                        ],
                                        ...
                                        return h(
                                            ...
                                            [
                                                ...Object.keys(
                                                    ...
                                                    BITMAP_DENSITIES.map(
                                                        (ds) => {
                                                            return BITMAP_FORMATS.map(
                                                                (ft) => {
                                                                    const keyForThumbnail = `${rs}_${ds}_${ft}`;
                                                                    return h(
                                                                        SingleInput,
