      ...
      return h("div", { class: "flex flex-col gap-4" }, [
        ...
        h("label", { class: "w-full flex flex-col gap-1" }, [
          ...
          h("input", {
            type: "file",
            style:
              "background-color: var(--color-gray-50); border-style:dashed;",
            accept: ".svg",
            class:
              "border-2 border-blue-300 rounded-sm p-1 w-full py-6 px-4 font-semibold text-sm hover:text-blue-800 cursor-pointer",
            onChange: (e) => {
        ...
        this.slice.content[language]
          ? h(
              "div",
              {
                class: "p-4",
                style:
                  "background-color: rgba(249,250,251,0.1);background-image: repeating-linear-gradient(45deg, #f1f5f9 25%, transparent 25%, transparent 75%, #f1f5f9 75%, #f1f5f9), repeating-linear-gradient(45deg, #f1f5f9 25%, rgba(249,250,251,0.1) 25%, rgba(249,250,251,0.1) 75%, #f1f5f9 75%, #f1f5f9);background-position: 0 0, 15px 15px;background-size: 30px 30px;",
              },
              ...
              Details,
              {
                label:
                  strings[document.documentElement.lang]
                    .svg_slice_show_more_options_button_label,
              },
              {
                default: () =>
                  h("div", { class: "w-full flex flex-wrap gap-2" }, [
                    h(SvgFitter, {
                      svg: this.slice.content[language],
                      onFit: (thenew) => {
        ...
        h(
          Details,
          {
            label:
              strings[document.documentElement.lang]
                .svg_slice_show_source_button_label,
          },
          {
            default: () =>
              h("label", { class: "w-full flex flex-col gap-1" }, [
                ...
                h("textarea", {
                  ...
                  class:
                    "border border-gray-300 rounded-sm p-1 font-mono h-32 leading-tight",
                  onChange: (e) => {
                    let updatedObject = {
                      ...this.slice.content,
                    };
