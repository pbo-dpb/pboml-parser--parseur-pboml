...
export default {
    ...
    render() {
        return h("div", {}, [
                ...
                TinyButton,
                {
                    onClick: (e) => {
                        ...
                        setTimeout(() => {
                            ...
                            setTimeout(() => {
                                this.$refs.renderer.setAttribute(
                                    "hidden",
                                    true,
                                );
                                this.$emit(
                                    "fit",
                                    this.$refs.renderer.querySelector("svg")
                                        .outerHTML,
                                );
                            }, 200);
                        }, 200);
            ...
            h("div", {
                innerHTML: this.svg,
                class: "w-full dark:invert flex flex-col items-center",
                ref: "renderer",
                hidden: true,
            }),
        ]);
