...
export default class Slice {
  constructor(payload) {
    ...
    this.readonly =
      payload.readonly !== undefined ? payload.readonly : defaults.readonly;
    this.display_label =
    ...
    this.state._unlocked =
      payload?.state?._unlocked !== undefined ? payload.state._unlocked : false;
  }
  ...
  renderEditingVnode(language = document.documentElement.lang) {
    return h(
      ...
      { slice: this, language: language, id: this.anchor, key: this.anchor },
    );
  }
